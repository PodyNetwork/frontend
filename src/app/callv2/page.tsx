...
const page = () => {
  ...
  const adjustVideoDimensions = useCallback(() => {
    if (streamInfoElement.current && streamControlsElement.current) {
      ...
      const availableHeightCalc = `calc(${availableHeight}px)`;
      ...
      <div className="w-full h-full relative px-10 flex flex-col">
        ...
        <div className="flex-1">
          <div className="w-full h-full bg-[#1C1E20] rounded-xl relative">
            ...
            <div className="bg-orange-300 bottom-3 left-3 absolute block rounded-full px-5 py-1.5 text-sm">John mark</div>
          </div>
          {/* <div
        ...
        <div
          className="relative mt-auto bg-blue100 py-3"
          aria-label="controls"
        ...
        >
          <div className="flex flex-row items-center justify-between gap-x-2">
            ...
            <div className="flex flex-row gap-x-2.5">
              ...
              <button className="w-9 h-9 rounded-full bg-pody-danger">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
