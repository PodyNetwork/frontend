...
export const ParticipantCustomTileNoIcon: React.FC<ParticipantTileProps> =
                  ...
                  {isCameraOff ? (
                    <div className="camera-off-placeholder relative">
                      ...
                      <div className="lk-participant-metadata">
                        <div className="flex flex-row items-center gap-x-1 text-xs truncate font-bold">
                        ...
                        <div>
                          {trackReference.source === Track.Source.Camera ? (
                            <>
                              ...
                              <div className="glass-effect flex flex-row items-center gap-x-1 text-xs font-bold">
                                <CustomParticipantName />
                              </div>
                            </>
                          ) : (
                            <div className="flex flex-row items-center gap-x-1 text-xs font-bold">
                              <CustomParticipantName>
                                &apos;s screen
                              </CustomParticipantName>
                            </div>
