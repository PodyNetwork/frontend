        ...
        <section className="w-full flex flex-col bg-white dark:bg-[#111114]">
          <div className="flex flex-col md:flex-row gap-x-2 h-screen max-h-screen md:justify-between relative">
            ...
            <CarouselHeightProvider>
              <div
                className={`__pd_bg_gradient dark:bg-pody-dark md:h-full pt-5 md:pt-5 md:py-5 px-3.5 flex flex-col gap-4 __main-screen relative float-left w-full ${
            ...
            <div
              className={`__pd_bg_gradient z-20 dark:bg-pody-dark pb-[100px] md:pb-5 overflow-y-auto md:overflow-hidden p-3.5 pt-6 w-full  relative flex flex-col gap-y-2 flex-1 md:flex-none ${
                participantBarIsExpanded
