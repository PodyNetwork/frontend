...
const Controls = ({
  ...
  return (
    <div
      className="hidden mt-auto h-10 md:flex flex-wrap justify-center items-center gap-x-3 text-sm"
      aria-label="controls"
    >
      {/* video source */}
      {visibleControls.camera && (
        <div className="bg-white px-1.5 h-10 rounded-full flex justify-center items-center text-slate-400">
