    ...
    <>
      <div
        className={`flex flex-col gap-y-1 ${
          isFullscreen
            ? "absolute top-0 left-0 px-1.5 md:px-5 z-50 w-full __dark_veil py-3"
            : "relative"
        } ${
          showInfo ? "visible" : "opacity-0"
        } transition-opacity duration-300`}
      >
        <div className="md:hidden relative w-full text-red-200 flex flex-row items-center text-xs xs:text-sm font-semibold justify-between gap-x-2">
