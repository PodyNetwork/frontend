        ...
        {participants.map((participant, index) => (
          ...
          >
            ...
            <div className="hidden md:flex flex-row items-center gap-x-2.5">
              ...
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className={`w-5 h-5 ${participant.isMicrophoneEnabled ? 'opacity-100 text-red-500' : 'opacity-40'}`}
                viewBox="0 0 24 24"
                style={{ msFilter: "" }}
                fill="currentColor"
              >
              ...
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className={`w-5 h-5 ${participant.isCameraEnabled ? 'opacity-100 text-red-500' : 'opacity-40'}`}
                viewBox="0 0 24 24"
                style={{ msFilter: "" }}
                fill="currentColor"
              >
