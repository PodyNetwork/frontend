    ...
    <>
      ...
      <div className="relative __gift_height_max overflow-y-auto px-4">
        {profile?.walletAddress ? (
              ...
              <div className="flex flex-nowrap max-w-sm relative overflow-x-auto gap-2">
                {filteredParticipants.length < 1 ? (
                  <span className="text-xs text-slate-500">
                    Oops, there is No Participant to Gift. Invite Participants
                    to the Classroom to start Gifting
                  </span>
                ) : (
            ...
            <div className="mt-4">
              ...
              <Select onValueChange={handleChangeToken}>
                    ...
                    {gifts.map((data: GiftItem, index: number) => (
                      ...
                      >
                        ...
                        >
                          ...
                          {!data.isAvailable && (
                            <div className="rounded px-1 py-px ms-1.5 bg-slate-500 text-slate-200 inline-block text-[0.6rem]">
                              Coming Soon
                            </div>
                          )}
                        </button>
                ...
                <p className="text-[0.7rem] text-slate-500 dark:text-slate-500 mt-1">
                  Only Tokens whitelisted by Pody Network are currently
                  supported.
                </p>
              </Select>
            </div>
          ...
          <div className="mt-3">
            <Image src="/illustration/gift-user.webp" width={400} height={500} alt="Pody Gift" className="w-full object-contain" />
            <p className="text-xs text-slate-500 mt-3">
              Gifting and receiving gifts in Anonymous Mode is not allowed. Only users who have minted the Pody Passport can Gift.
            </p>
          </div>
        )}
      </div>
