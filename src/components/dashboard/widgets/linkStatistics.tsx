...
const LinkStatistics = () => {
  return (
    <div className="bg-pody-dark p-6 rounded-xl h-full relative flex flex-col w-full">
        <div className="pb-3">
          <h1 className="text-lg text-slate-200">Meeting Statistics</h1>
        </div>
        <div className="relative flex flex-row gap-x-6">
          <div className="w-48 mt-auto">
            ...
            <div className="h-1.5 w-full flex flex-row gap-x-1">
              ...
              <div className="w-[42%] h-full rounded-[10px] bg-[#ff802e]"></div>
              <div className="w-[7%] h-full rounded-[10px] bg-[#f06db5]"></div>
            </div>
          </div>
          <div className="flex-1">
            <div className="grid grid-cols-4 bg-pody-dark_secondary rounded-2xl p-6">
              ...
              <div className="flex flex-col items-center">
                <div className="w-10 h-10 rounded-full bg-[#f06db5] flex items-center justify-center">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="w-6 h-6"
                    viewBox="0 -960 960 960"
                ...
                <div className="pt-5 text-center">
                  <h2 className="text-2xl text-slate-200">02</h2>
                  <p className="text-sm text-slate-300 pt-1">Schedule</p>
                </div>
              </div>
            </div>
          </div>
