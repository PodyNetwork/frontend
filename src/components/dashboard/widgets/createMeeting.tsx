    ...
    <>
      <div className="flex flex-col gap-y-4">
        ...
        <div className="text-sm mt-2 flex flex-col xs:flex-row flex-wrap text-nowrap gap-2">
          {profile?.walletAddress ? <Drawer /> : <Link href={'/signup'}
            className={`px-6 py-2 bg-pody-primary text-center outline-none text-slate-900 cursor-pointer rounded-md hover:bg-pody-primary/80 flex-1 hover:transition-all w-full xs:w-auto`}
          >Signup</Link>}
        </div>
