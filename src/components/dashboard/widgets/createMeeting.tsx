      ...
      <div className="flex flex-col gap-y-4">
        ...
        <div className="text-sm mt-2 flex flex-col xs:flex-row flex-wrap text-nowrap gap-2">
          <DropdownMenu>
            <DropdownMenuTrigger>
              <button
                className={`px-6 py-1.5 bg-pody-primary text-slate-900 rounded-md hover:bg-pody-primary/80 flex-1 hover:transition-all w-full xs:w-auto ${
            ...
            <DropdownMenuContent>
              <DropdownMenuItem>Public Classroom</DropdownMenuItem>
              <DropdownMenuItem>Private Classroom</DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
          <ScheduleDrawer />
        </div>
