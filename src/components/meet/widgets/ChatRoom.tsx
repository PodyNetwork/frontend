...
const ChatRoom = () => {
  return (
    <div className='fixed bottom-0 z-50 left-0 md:relative w-full h-[70%] md:max-h-[350px] md:min-h-[350px] bg-white shadow-xl shadow-pody-primary/10 rounded-xl'>
        <div className='px-7 p-5'>
            ...
            <div className='flex flex-col gap-y-3.5'>
                <div className='gap-x-3 __sender_chat'>
                    ...
                    <div className='text-sm bg-slate-100 w-full px-3.5 py-2.5 __message_chat flex items-center text-slate-700'>
                        Can you hear my voice Eax
                    </div>
                </div>
                <div className='gap-x-3 __receiver_chat'>
                    <Image src={userLogo} alt='user icon' className='w-7 h-7 object-contain self-end' />
                    <div className='text-sm bg-slate-100 w-full px-3.5 py-2.5 __message_chat_sender flex items-center text-slate-700'>
